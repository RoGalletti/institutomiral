...
export function StudentLayout({ children }: StudentLayoutProps) {
  ...
  const navigation = [
    ...
    { name: "Buscar Cursos", href: "/student/browse", icon: Search },
    { name: "Descargas", href: "/student/downloads", icon: Download },
    { name: "Mensajes", href: "/student/messages", icon: MessageSquare },
    { name: "Pagos", href: "/student/payments", icon: CreditCard },
    { name: "Reseñas", href: "/student/reviews", icon: Star },
